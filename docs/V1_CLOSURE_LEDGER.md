...
| **P1-01** | P1 | CI | Snapserver Real Daemon Integration | No | Sí | `IN_PROGRESS` | Requiere evidencia de ejecución real con daemon snapserver para GA (en progreso hasta evidencia en CI) |
